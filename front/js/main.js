...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const start = async () => {
    ...
    robot.scene.scale.set(0.2, 0.2, 0.2); // Escalar el robot
    ...
    // Cargar y configurar el modelo 3D del logo F5
    const f5 = await loadGLTF("./assets/f5.gltf");
    f5.scene.scale.set(2, 2, 2);           // Escalar el logo
    f5.scene.position.set(0.3, 1, 0);      // Posicionar a la derecha y arriba
